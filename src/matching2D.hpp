...
void visualizeKeypoints(const std::vector<cv::KeyPoint> &keypoints, const cv::Mat &img, const std::string& windowName, bool saveImageFiles, ExperimentResult &result);
